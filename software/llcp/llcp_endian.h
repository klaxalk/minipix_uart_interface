...
inline uint16_t __attribute__((__const__)) llcp_hton16(uint16_t h16) {
...
inline uint16_t __attribute__((__const__)) llcp_ntoh16(uint16_t n16) {
  return llcp_hton16(n16);
}

/* Convert 32-bit number from host byte order to network byte order */
inline uint32_t __attribute__((__const__)) llcp_hton32(uint32_t h32) {
#ifdef LLCP_BIG_ENDIAN
  return h32;
#else
...
inline uint32_t __attribute__((__const__)) llcp_ntoh32(uint32_t n32) {
  return llcp_hton32(n32);
}

/* Convert 64-bit number from host byte order to network byte order */
inline uint64_t __attribute__((__const__)) llcp_hton64(uint64_t h64) {
#ifdef LLCP_BIG_ENDIAN
  return h64;
#else
...
/* Convert 64-bit number from host byte order to network byte order */
inline uint64_t __attribute__((__const__)) llcp_ntoh64(uint64_t n64) {
  return llcp_hton64(n64);
}

/* Convert 16-bit number from host byte order to big endian byte order */
inline uint16_t __attribute__((__const__)) llcp_htobe16(uint16_t h16) {
  return llcp_hton16(h16);
}

/* Convert 16-bit number from host byte order to little endian byte order */
inline uint16_t __attribute__((__const__)) llcp_htole16(uint16_t h16) {
...
inline uint32_t __attribute__((__const__)) llcp_betoh32(uint32_t be32) {
  return llcp_ntoh32(be32);
}

/* Convert 32-bit number from little endian byte order to host byte order */
inline uint32_t __attribute__((__const__)) llcp_letoh32(uint32_t le32) {
  return llcp_htole32(le32);
}

/* Convert 64-bit number from host byte order to big endian byte order */
inline uint64_t __attribute__((__const__)) llcp_htobe64(uint64_t h64) {
  return llcp_hton64(h64);
}

/* Convert 64-bit number from host byte order to little endian byte order */
inline uint64_t __attribute__((__const__)) llcp_htole64(uint64_t h64) {
#ifdef LLCP_LITTLE_ENDIAN
  return h64;
#else
  return (((h64 & 0xff00000000000000LL) >> 56) | ((h64 & 0x00000000000000ffLL) << 56) | ((h64 & 0x00ff000000000000LL) >> 40) |
...
inline uint64_t __attribute__((__const__)) llcp_betoh64(uint64_t be64) {
  return llcp_ntoh64(be64);
}

/* Convert 64-bit number from little endian byte order to host byte order */
inline uint64_t __attribute__((__const__)) llcp_letoh64(uint64_t le64) {
